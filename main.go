...
//this struct has data that we want to extract for json handling
type Result struct {
...
//now we will create a function that will fetch comics from the url
...
func main() {
	...
	//wait for all the results to be collected
	<-done
	//convert to json
